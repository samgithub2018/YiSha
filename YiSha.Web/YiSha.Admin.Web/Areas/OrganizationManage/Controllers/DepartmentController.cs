...
namespace YiSha.Admin.Web.Areas.OrganizationManage.Controllers
{
    ...
    public class DepartmentController : BaseController
    {
        ...
        {         
            TData<List<DepartmentEntity>> obj;
            obj = await sysDepartmentBLL.GetList(param);
            return Json(obj);
        }
        ...
        public async Task<IActionResult> GetDepmentForShopJson()
        {
            var treeList = await sysDepartmentBLL.GetDepmentForShopJson();
